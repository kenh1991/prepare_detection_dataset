...
import os
import shutil
ann_filepath='./test/1/Annotations/'
img_filepath='./test/1/JPEGImages/'
img_savepath='./test/1/JPEGImages_air_merge/'
ann_savepath='./test/1/Annotations_air_merge/'
...
for file in os.listdir(ann_filepath):
    ...
    classes1 = '\t\t<name>feiji</name>\n'
    classes2 = '\t\t<name>feiji1</name>\n'
